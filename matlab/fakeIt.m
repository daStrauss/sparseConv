...
for pp = 1:3
    ...
    set(gca,'YTickLabel', [])
    set(gca,'XTickLabel', [])
    text(250,0,['w_' num2str(pp)],'BackgroundColor','w','EdgeColor','k')
end
...
print('-depsc2', '/shared/users/dstrauss/ant_net/talks/convNets/images/addSum')


mkk = reshape(squeeze(fp.z), m,p+1);
